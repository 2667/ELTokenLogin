...
- (void)viewDidLoad {
    ...
    [weixin setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ...
    qq.backgroundColor = [UIColor redColor];
     [qq setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
...
//     [sina setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    sina.titleLabel.textColor = [UIColor blueColor];
